...
fn test_streaming_write_incremental_read() {
    let filename = "test_streaming.bdf";
...
fn test_random_access_streaming() {
    let filename = "test_random_streaming.bdf";
...
fn test_large_file_handling() {
    let filename = "test_large_file.bdf";
...
fn test_concurrent_read_access() {
    let filename = "test_concurrent.bdf";
...
fn test_streaming_with_annotations() {
    let filename = "test_streaming_annotations.bdf";
