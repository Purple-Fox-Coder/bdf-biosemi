...
//!     # let mut writer = EdfWriter::create("test_data.bdf")?;
...
//!
//!     // Open an EDF+ file
//!     let mut reader = EdfReader::open("test_data.bdf")?;
//!
...
//!     # // Cleanup
//!     # drop(reader);
//!     # fs::remove_file("test_data.bdf").ok();
//!     Ok(())
//! }
//! ```
//!
...
//! fn main() -> Result<()> {
//!     // Create a writer
//!     let mut writer = EdfWriter::create("test_output.bdf")?;
//!
...
//!
//!     # // Cleanup
//!     # fs::remove_file("test_output.bdf").ok();
//!     Ok(())
//! }
//! ```
